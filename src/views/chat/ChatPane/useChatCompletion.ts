...
const CHAT_COMPLETIONS_URL = 'http://localhost:10000/v1/chat/completions'
...
export const useChatCompletion = (
  ...
  const send = useCallback(
    (newMessages?: ChatMessageParams[],model?:string, callback?: any) => {
   ...
   // console.log(CHAT_COMPLETIONS_URL)
