...
export function ArticlePane(props: AccountsPaneProps) {
	...
	const fetchRecords = useStable(async () => {
		const response = await executeQuery(`select * from feed_item where id=$id`,{
			id:props.activeFeedItem
		});
		...
		<ContentPane
			...
			>
				<Stack gap={0}>
						...
						<Group key={records.id} gap="xs" w="100%" wrap="nowrap"
						...
						>
							...
							/>
							{/* <Text>*/}
							{/*	{ReactHtmlParser(records.content)}*/}
							{/*</Text>*/}
							<Spacer/>
