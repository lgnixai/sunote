...
import {ActionIcon, Box, Button, Group, Image, Modal, Stack, Text, TextInput, Tooltip} from "@mantine/core";
...
export function ConnectionsLogo() {
		...
		<>
			{connection ? (
				<Button.Group>
						...
						<Image src={surrealistLogo} w={42}  onClick={isListingHandle.toggle} />
